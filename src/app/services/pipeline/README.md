...
3. **[DetectorCropperService](file:///d:/Repositories/PoC-LensClone/src/app/services/text-detection/cropper/cropper.service.ts)**: Crops the bounding box regions out of the main canvas into smaller sub-images for OCR.
...
6. **[LineGroupingService](file:///d:/Repositories/PoC-LensClone/src/app/services/text-detection/line-grouping/line-grouping.service.ts)**: Merges adjacent horizontal text chunks to maintain standard reading order flow.
